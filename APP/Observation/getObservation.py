...
def search_page2():
    ...
    if request.method == 'POST':
        ...
        response = config.search_fhir_data2("Observation", search_param1, search_param2, search_param3, search_param4,
                                            search_text1, search_text2, search_text3, search_text4)
